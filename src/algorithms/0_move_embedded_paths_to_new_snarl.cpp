...
*/
    ...
    if (_debug_print==true)
    {
        ...
        cerr << "all handles in main graph source and sink: " << endl;
        ...
        test.for_each_handle([&](handle_t handle)
        {
            ...
            cerr << "lefts: ";
            test.follow_edges(handle, true, [&](handle_t left){
                cerr << test.get_id(left) << " ";
            });
            cerr << endl;
            cerr << "rights: ";
            test.follow_edges(handle, false, [&](handle_t right){
                cerr << test.get_id(right) << " ";
            });
            cerr << endl;
        });
    }
